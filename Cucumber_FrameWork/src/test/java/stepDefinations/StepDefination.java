...
public void user_Enter_in_lane(String lname) throws Throwable {
	driver.findElement(By.name("lastName")).sendKeys(lname);
}

@When("^user Capture EID Before Adding$")
public void user_Capture_EID_Before_Adding() throws Throwable {
    Expeccted = driver.findElement(By.name("employeeId")).getAttribute("value");
}
...
public void user_validates_EID() throws Throwable {
    if(Expeccted.equals(Actual))
    {
    	System.out.println("Add New Employee Created Success::"+Expeccted+"============"+Actual);
    }
    else
    {
    	System.out.println("Add New Employee Created Fail::"+Expeccted+"============"+Actual);
    }
}
